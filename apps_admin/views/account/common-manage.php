            ...
            <div class="row">
                <div class="tabbable">
                    <ul class="nav nav-tabs" id="myTab">
                        ...
                        <li>
                            <a  href="<?php echo Url::to(['account/common-add']) ?>">
...
<script type="text/javascript">
    seajs.use(['admin-common','$','dataTables',"dataTables-bootstrap"],function(admin,$){
        var oTable = $('#sample-table').dataTable({
            ...
            "aoColumns" : [ //列操作
                ...
                },
                {
                    ...
                    "mRender" : function (data,type,full) {
                        var editurl = "<?php echo Url::to(['account/common-disable']) ?>&id=" + data + "&sta=" + full['status'];
                        var delurl = "<?php echo Url::to(['account/commdel']) ?>&id=" + data;
            ...
            "sAjaxSource" : "<?php echo Url::to(['account/common-manage']) ?>",
            "sServerMethod" : "POST",
            "fnServerParams": function (aoData) {  //查询条件
                aoData.push({"name": "acid", "value": <?php echo $acid; ?>});
            },
            //"bProcessing": true,
